...
if __name__ == '__main__':
    url = 'https://list.tmall.com/search_product.htm?q=%C7%E5%D1%EF&type=p&spm=a220m.1000858.a2227oh.d100&from=.list.pc_1_searchbutton'
    html = get_html(url)
    ...
    for item in soup.find_all('div', class_='product'):
        ...
        print(data)
        filename = '{}\QingYang.csv'.format(os.getcwd())
